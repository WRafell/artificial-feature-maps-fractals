from src.diffusion.blocks import DownBlock, MidBlock, UpBlockUnet
from src.diffusion.blocks import get_time_embedding
    ...
    def __init__(self, im_channels, model_config):
        ...
        if self.image_cond:
            ...
            self.conv_in = nn.Sequential(
                # nn.Conv2d(1, im_channels, kernel_size=3, stride=1, padding=1),
                nn.Conv2d(im_channels, self.down_channels[0], kernel_size=3, padding=1)
            )            
        ...
        # self.conv_in = nn.Conv2d(1, 3, kernel_size=3, stride=1, padding=1)
